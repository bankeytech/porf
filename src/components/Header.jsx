              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className='w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700 outline-none text-sm font-medium'
                  />
                </div>
                ...
                whileTap={{ scale: 0.97 }}
                className='w-full px-4 py-2 text-sm font-medium bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg hover:shadow-violet-600/50'>
                  Send Message
                </motion.button>
              </form>
            </motion.div>
